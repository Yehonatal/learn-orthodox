                ...
                <div className="flex flex-col items-center text-center border-b border-accent-gold/10 pb-6 mb-8">
                    ...
                    >
                        <img
                            ...
                            className="h-12 w-auto object-contain mb-2 filter drop-shadow-[0_2px_4px_rgba(197,146,70,0.1)] group-hover:scale-105 transition-transform duration-300"
                        />
                        ...
                        <span className="block text-[8px] tracking-widest text-stone-500 uppercase mt-0.5">
                    ...
                    <p className="text-[10px] text-accent-crimson font-bold uppercase tracking-wider mt-1">
                        Liturgy Slug: {note.liturgy_slug} &bull; Section:{" "}
